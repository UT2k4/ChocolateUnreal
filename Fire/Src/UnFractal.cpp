...
void UWaterTexture::CalculateWater()
{
	...
	BYTE* BitMapAddr  = &Mips(0).Data(0);   //pointer
...
#else
		if( bRising ) CalcWrapFire( &Mips(0).Data(0), RenderTable, USize, VSize );
		else      CalcSlowFire( &Mips(0).Data(0), RenderTable, USize, VSize );
#endif
